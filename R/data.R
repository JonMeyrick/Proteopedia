...
#' variable groups with the colours White, Yellow, Orange, Red, Black
#' @format A character string of 46 length.
#' @source Created by Jon Meyrick
"ThermalPalette"
#' 
#' Proteopedia is a comprehensive dataset of the Human proteome, with varios annotations of interest in proteomic analysis
